...
using bf2srvWebAdmin.Server.Commands;
using bf2srvWebAdmin.Server.Commands.BF2;
...
using MessageType = bf2srvWebAdmin.Common.Entities.Game.MessageType;

// TODO: split match and command handling
namespace bf2srvWebAdmin.Server.Modules.BF2;
