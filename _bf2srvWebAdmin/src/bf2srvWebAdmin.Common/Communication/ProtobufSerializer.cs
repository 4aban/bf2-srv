...
using bf2srvWebAdmin.Common.Abstractions;
using bf2srvWebAdmin.Shared;
using ProtoBuf;

namespace bf2srvWebAdmin.Common.Communication;
...
public class ProtobufSerializer : IMessageSerializer
{
    public ProtobufSerializer(string protoPath = null)
    {
        ...
        //SaveProto(@"C:\Projects\DotNet\bf2srvWebAdmin\src\bf2srvWebAdmin.Web\bf2srvWebAdmin.Web\App\messages.proto");
    }
