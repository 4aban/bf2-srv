...
namespace bf2srvWebAdmin.Data.Migrations
{
    ...
    [Migration("20220824004546_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MapMod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MapModObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.Match", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MatchRound", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MatchRoundPlayer", b =>
                {
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.Server", b =>
                {
                    b.Property<string>("ServerId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.ServerModule", b =>
                {
                    b.Property<string>("ServerGroup")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.ServerPlayerAuth", b =>
                {
                    b.Property<string>("ServerGroup")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MapModObject", b =>
                {
                    b.HasOne("bf2srvWebAdmin.Data.Entities.MapMod", "MapMod")
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MatchRound", b =>
                {
                    b.HasOne("bf2srvWebAdmin.Data.Entities.Match", "Match")
            ...
            modelBuilder.Entity("bf2srvWebAdmin.Data.Entities.MatchRoundPlayer", b =>
                {
                    ...
                    b.HasOne("bf2srvWebAdmin.Data.Entities.MatchRound", "Round")
