...
using bf2srvWebAdmin.Server;
using bf2srvWebAdmin.Server.Controllers;
...
try
{
    ...
    builder.Services.AddHostedService<bf2srvWebAdminService>();
    ...
    app.Logger.LogInformation("bf2srvWebAdmin.Server is starting");
