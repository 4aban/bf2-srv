...
namespace bf2srvWebAdmin.Server;

public class bf2srvWebAdminService : BackgroundService
{
    private readonly ISocketServer _server;
    private readonly IHostApplicationLifetime _applicationLifetime;
    private readonly ILoggerFactory _loggerFactory;
    private readonly ILogger<bf2srvWebAdminService> _logger;
    private readonly ServerSettings _settings;

    public bf2srvWebAdminService(IOptions<ServerSettings> settings, ISocketServer server, IHostApplicationLifetime applicationLifetime, ILoggerFactory loggerFactory)
    {
        _server = server;
        _applicationLifetime = applicationLifetime;
        _loggerFactory = loggerFactory;
        _logger = loggerFactory.CreateLogger<bf2srvWebAdminService>();
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        using var activity = Telemetry.ActivitySource.StartActivity(nameof(bf2srvWebAdminService));
