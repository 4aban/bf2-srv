...
namespace bf2srv-wadmin.Server;

public class bf2srv-wadminService : BackgroundService
{
    private readonly ISocketServer _server;
    private readonly IHostApplicationLifetime _applicationLifetime;
    private readonly ILoggerFactory _loggerFactory;
    private readonly ILogger<bf2srv-wadminService> _logger;
    private readonly ServerSettings _settings;

    public bf2srv-wadminService(IOptions<ServerSettings> settings, ISocketServer server, IHostApplicationLifetime applicationLifetime, ILoggerFactory loggerFactory)
    {
        _server = server;
        _applicationLifetime = applicationLifetime;
        _loggerFactory = loggerFactory;
        _logger = loggerFactory.CreateLogger<bf2srv-wadminService>();
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        using var activity = Telemetry.ActivitySource.StartActivity(nameof(bf2srv-wadminService));
