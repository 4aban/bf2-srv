...
using bf2srv-wadmin.Server;
using bf2srv-wadmin.Server.Controllers;
...
try
{
    ...
    builder.Services.AddHostedService<bf2srv-wadminService>();
    ...
    app.Logger.LogInformation("bf2srv-wadmin.Server is starting");
